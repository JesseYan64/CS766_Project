...
def stitch_and_save_images(source_folder_a, target_folder_b, train_folder, test_folder):
    ...
    images_a_train, images_a_test, images_b_train, images_b_test = train_test_split(images_a, images_b, test_size=0.3, random_state=42)
...
if __name__ == "__main__":
    source_folder_X = 'data/r_cover'
    source_folder_y = 'data/no_cover'
    train_folder = 'data/train_r'
    test_folder = 'data/test_r'
