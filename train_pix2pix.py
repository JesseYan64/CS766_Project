...
def train(args):
    ...
    logger = Logger(exp_name='./runs/pix2pix', filename='pix2pix')
    total_time = 0
    epoch_start = 0
    # Whether has a checkpoint
    if os.path.exists('./runs/pix2pix/checkpoint.pt'):
        checkpoint = torch.load('./runs/pix2pix/checkpoint.pt')
